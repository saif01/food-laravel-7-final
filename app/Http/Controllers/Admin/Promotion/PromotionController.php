...
class PromotionController extends Controller
{
    ...
    public function All()
    {
        ...
        return view('admin.food.all-promotion');
    }
    ...
    public function Store(Request $request)
    {
        ...
        if ($error->fails()) {
            ...
            if ($image) {
                $image_name = "promotions" . Str::random(5);
                $ext = strtolower($image->getClientOriginalExtension());
                $image_full_name = $image_name . '.' . $ext;
                //Small ImageUpload Path
                $upload_path_small = 'public/images/promotions/small/';
                ...
                $upload_path_original = 'public/images/promotions/original/';
