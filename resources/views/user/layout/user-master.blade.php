        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-expand-lg navbar-dark shadow-sm" style="background:#e51937; padding: inherit;">
                <div class="container">
                    ...
                    <a href="{{ url('/') }}" class="navbar-brand font-weight-bold"><img class="img-rounded" src="{{ asset('all-assets/user/images/food.ico') }}" alt="Logo" height="50" width="50"> CP Five Star</a>
                    ...
                    <div id="navbarContent" class="collapse navbar-collapse">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <!-- Level two dropdown-->
                                    @php
                                    $cat_data = App\Models\Category::orderBy('name')->get();
                                    @endphp

                                    @foreach($cat_data as $cat)
                                    <li class="dropdown-submenu">
                                    <a id="dropdown{{ $cat->name.$cat->id }}" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">{{ $cat->name }}</a>
                                    ...
                                    <ul aria-labelledby="dropdown{{ $cat->name.$cat->id }}" class="dropdown-menu border-0 shadow">
                                        <li>
