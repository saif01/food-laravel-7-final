...
@section('title', 'CP Five Star Product Details')
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block img-thumbnail w-100 sliderPic" src="{{ asset($singleData->image) }}" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block img-thumbnail w-100 sliderPic" src="{{ asset($singleData->image2) }}" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block img-thumbnail w-100 sliderPic" src="{{ asset($singleData->image3) }}" alt="Third slide">
                            </div>
                        </div>
